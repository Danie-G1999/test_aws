    ...
    <div class="w-screen h-screen flex">
      ...
      <div class="w-[400px] h-full bg-gray-200 text-white" v-show="showSide">
        <div class="h-[50px] bg-gray-900 flex justify-start  items-center ">
          <div class="px-[20px]">
            <h3 class="font-bold text-xl cursor-pointer">
              <router-link to="/" class="text-inherit">
                Contacts
              </router-link>
            </h3>
          </div>
          ...
          <div class="w-[calc(100%-30px)] flex">
            ...
            <div class="w-[200px] ">
              <!-- <div class="flex items-center justify-start space-x-4 cursor-pointer" @click="toggleDrop">
                <img class="w-10 h-10 rounded-full border-2 border-gray-50 object-cover"
                src="@/assets/profile.jpeg" alt="profile">
                <div class="font-semibold text-left">
                  <div>Daniel G,Dev MID</div>
                  <div class="text-xs text-gray-500 dark:text-gray-600">Admin</div>
                </div>
              </div> -->
              <!-- Drop down -->
